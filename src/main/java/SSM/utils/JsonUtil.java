...
public class JsonUtil {
    ...
    //字符串转json
    public static <T> T string20bj(String str, Class<T> clazz) {
...
//        User user = JsonUtil.string20bj(userJson, User.class);
